...
export default class VisibilityExampleVisibility extends Component {
    ...
    contextRef = createRef<HTMLElement>()

    handleUpdate = (e: any, { calculations }: any) => this.setState({ calculations })
        ...
        return (
            <>
                <Sticky context={this.contextRef}>
                    {/*<Progress percent={(calculations.percentagePassed * 100).toFixed()} progress />*/}
